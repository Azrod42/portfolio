        ...
        <div className={styles.container}>
            ...
            <div className={styles.project} id="ft_irc">
                <div className={styles.projectText}>
                    ...
                    <p className={`${styles.p} ${fontP.className}`}>ft_irc is a group project that involves creating an IRC server (from scratch, in C++), as the
                ...
                <div className="project-image">
                    <Image src={'/42-project/ft_irc.png'} alt={'ft_irc'} width={200} height={200} className={styles.img}/>
                </div>
            </div>
            <hr className={styles.hr} />
            <div className={styles.projectR} id="inception">
                <div className={styles.projectText}>
                    ...
                    <p className={`${styles.p} ${fontP.className}`}>Docker is used extensively with docker-compose in this project with multiple constraints: hosting a multi-container wordpress, reverse-proxy and SSL certificates.</p>
                    <div className={styles.stack}>
            ...
            <div className={styles.project} id="cub3D">
                <div className={styles.projectText}>
                    ...
                    <p className={`${styles.p} ${fontP.className}`}>cub3D is a two-person graphics project in which we create a game that resembles an old FPS, such as Wolfenstein 3D. To achieve this, we use C programming language and implement Raycasting, with a very minimalistic graphics library called MinilibX (which renders pixel by pixel).</p>
                    <div className={styles.stack}>
                        <p className={styles.stackType}>{'\xa0\xa0#C\xa0\xa0'}</p>
            ...
            <div className={styles.projectR} id="NetPractice">
                <div className={styles.projectText}>
                    ...
                    <p className={`${styles.p} ${fontP.className}`}>NetPractice is a project consisting of 10 exercises designed to introduce us to networking concepts such as subnet masks, routers, switches, and more.</p>
                    <div className={styles.stack}>
                        <p className={styles.stackType}>{'\xa0\xa0#Network\xa0\xa0'}</p>
                    </div>
                </div>
            ...
            <div className={styles.project} id="PiscineC++">
                <div className={styles.projectText}>
                    ...
                    <p className={`${styles.p} ${fontP.className}`}>A C++ pool consisting of 9 modules aimed at deepening the understanding of concepts such as classes and polymorphism, templates, and casts.</p>
                    <div className={styles.stack}>
                        <p className={styles.stackType}>{'\xa0\xa0#C++\xa0\xa0'}</p>
                    </div>
                </div>
            ...
            <div className={styles.projectR} id="Minishell">
                <div className={styles.projectText}>
                    ...
                    <p className={`${styles.p} ${fontP.className}`}>A major project completed in pairs, aimed at creating a command interpreter that mimics bash. Minishell handles environment variables, launches programs and manages their returns, as well as pipes and redirects. Additionally, it includes several built-in functions such as cd, echo, env, exit, export, pwd, and unset.</p>
                    <div className={styles.stack}>
                        <p className={styles.stackType}>{'\xa0\xa0#C\xa0\xa0'}</p>
            ...
            <div className={styles.project} id="Philosophers">
                <div className={styles.projectText}>
                    ...
                    <p className={`${styles.p} ${fontP.className}`}>Modeling the Dining Philosophers problem, first by representing each philosopher as a thread and each fork as a mutex, and secondly by representing each philosopher as a forked child process and the forks as semaphores.</p>
                    <div className={styles.stack}>
                        <p className={styles.stackType}>{'\xa0\xa0#C\xa0\xa0'}</p>
            ...
            <div className={styles.projectR} id="push_swap">
                <div className={styles.projectText}>
                    ...
                    <p className={`${styles.p} ${fontP.className}`}>push_swap is an algorithmic project aimed at sorting a stack with the fewest possible operations using a temporary stack. We are allowed to use two operations that are not normally available on stacks: rotate and reverse rotate.</p>
                    <div className={styles.stack}>
                        <p className={styles.stackType}>{'\xa0\xa0#C\xa0\xa0'}</p>
            ...
            <div className={styles.project} id="Minitalk">
                <div className={styles.projectText}>
                    ...
                    <p className={`${styles.p} ${fontP.className}`}>The task is to enable communication between two programs, a server and a client, using two Unix signals sent with KILL, which means sending binary data through Unix signals. The challenge is to receive the bits in the order they were sent.</p>
                    <div className={styles.stack}>
                        <p className={styles.stackType}>{'\xa0\xa0#C\xa0\xa0'}</p>
            ...
            <div className={styles.projectR} id="So_long">
                <div className={styles.projectText}>
                    ...
                    <p className={`${styles.p} ${fontP.className}`}>so_long is a graphical program where we generate a 2D game. The interactive map is created from a .txt file and developed using a simplistic graphics library that allows for pixel-by-pixel display.</p>
                    <div className={styles.stack}>
                        <p className={styles.stackType}>{'\xa0\xa0#C\xa0\xa0'}</p>
                        <p className={styles.stackType}>{'\xa0\xa0#Unix\xa0\xa0'}</p>
                        <p className={styles.stackType}>{'\xa0\xa0#Signals\xa0\xa0'}</p>
            ...
            <div className={styles.project} id="ft_printf">
                <div className={styles.projectText}>
                    ...
                    <p className={`${styles.p} ${fontP.className}`}>The task is to recreate the printf function from the C standard library. ft_printf works exactly the same way as printf, but `&quot;`only`&quot;` with the following flags: %cspdiuxX.</p>
                    <div className={styles.stack}>
                        <p className={styles.stackType}>{'\xa0\xa0#C\xa0\xa0'}</p>
                    </div>
                </div>
            ...
            <div className={styles.projectR} id="get_next_line">
                <div className={styles.projectText}>
                    ...
                    <p className={`${styles.p} ${fontP.className}`}>The task is to recreate the getline() function from the C standard library. get_next_line allows, like getline, to return each line of a file successively. It is possible to vary the size of the buffer.</p>
                    <div className={styles.stack}>
                        <p className={styles.stackType}>{'\xa0\xa0#C\xa0\xa0'}</p>
                    </div>
                </div>
            ...
            <div className={styles.project} id="Born2beroot">
                <div className={styles.projectText}>
                    ...
                    <p className={`${styles.p} ${fontP.className}`}>Installing Wordpress on a Debian server following very strict security, encryption and partitioning rules. Create a simple monitoring script using Bash.</p>
                    <div className={styles.stack}>
            ...
            <div className={styles.projectR} id="libft">
                <div className={styles.projectText}>
                    <h2 className={styles.h2}>Born2beroot :</h2>
                    <p className={`${styles.p} ${fontP.className}`}>The goal of this project is to have us create a library containing many commonly used functions in C, but that we must code from scratch. We will use our own standard library `&quot;`libft`&quot;` in future 42 projects.</p>
                    <div className={styles.stack}>
                        <p className={styles.stackType}>{'\xa0\xa0#C\xa0\xa0'}</p>
                    </div>
                </div>
